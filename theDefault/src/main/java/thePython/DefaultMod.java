...
import thePython.cards.*;
import thePython.characters.TheDefault;
import thePython.events.IdentityCrisisEvent;
import thePython.potions.PlaceholderPotion;
import thePython.relics.BottledPlaceholderRelic;
import thePython.relics.DefaultClickableRelic;
import thePython.relics.PlaceholderRelic;
import thePython.relics.PlaceholderRelic2;
import thePython.util.IDCheckDontTouchPls;
import thePython.util.TextureLoader;
import thePython.variables.DefaultCustomVariable;
import thePython.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "thePythonResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "thePythonResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "thePythonResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "thePythonResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "thePythonResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "thePythonResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "thePythonResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "thePythonResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "thePythonResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "thePythonResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "thePythonResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "thePythonResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "thePythonResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "thePythonResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "thePythonResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "thePythonResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "thePythonResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("thePython") // ${project.artifactId}
