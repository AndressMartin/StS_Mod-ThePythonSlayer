...
import thePython.patches.relics.BottledPlaceholderField;
import thePython.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static thePython.DefaultMod.makeRelicOutlinePath;
import static thePython.DefaultMod.makeRelicPath;
